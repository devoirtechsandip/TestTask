<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="RevenueDetailed.aspx.cs" Async="true" Inherits="RevenueDetailed" %>
...
<cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy" TargetControlID="txtstartdate"></cc1:CalendarExtender>
    ...
    <ItemTemplate>
        <tr>
            ...
            <td><%#Eval("client")%></td>
            <td><%#Eval("pono")%></td>
            <td><%#Eval("Inventory/Package Code")%></td>
            <td><%#Eval("type")%></td>
