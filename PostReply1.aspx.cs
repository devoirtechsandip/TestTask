...
public partial class PostReply1 : System.Web.UI.Page
{
    ...
    protected void btnSubmitReply_Click1(object sender, EventArgs e)
    {
        InsertRole();
    }
    ...
    public void clear()
    {
        try
        {
            txtReply1.Text = string.Empty;
            txtBCC1.Text = string.Empty;
        }
        catch (Exception ex)
        { }
    }
    ...
    private void InsertRole()
    {
        try
        {
            ...
            var rply = (string.IsNullOrEmpty(txtReply1.Text.Trim())) ? string.Empty : txtReply1.Text.Trim();
            var bcc = (string.IsNullOrEmpty(txtBCC1.Text.Trim())) ? string.Empty : txtBCC1.Text.Trim();
            query = "insert into [PostReply1_Master](Username,ReplyMessage,BCC,DatePosted,TicketId)" + 
                "values('" + "Deepak" + "','" + rply + "','" + bcc + "','" + DateTime.Now + "','" + Convert.ToInt32(lblTicketId.Text) + "')";
