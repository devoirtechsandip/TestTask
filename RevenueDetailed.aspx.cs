...
public partial class RevenueDetailed : System.Web.UI.Page
{
    ...
    protected void btndownload_Click(object sender, EventArgs e)
    {
        try
        {
            string Path = "Revenue Detailed.xls";
    ...
    protected void btnGenerate_Click(object sender, EventArgs e)
    {
        try
        {
            using (SqlConnection cnn = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["constr"].ConnectionString))
            {
                ...
                String str = "exec [revenuedetails] '" + DateTime.ParseExact(txtstartdate.Text, "dd/MM/yyyy", null).ToString("MM/dd/yyyy") + "', '" + DateTime.ParseExact(txtEndDate.Text, "dd/MM/yyyy", null).ToString("MM/dd/yyyy") + "'";
