...
public partial class RevenueReport : System.Web.UI.Page
{
    ...
    protected void btndownload_Click(object sender, EventArgs e)
    {
        try
        {
            string Path = "Revenue Report.xls";
    ...
    protected void btnGenerate_Click(object sender, EventArgs e)
    {
        try
        {
            using (SqlConnection cnn = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["constr"].ConnectionString))
            {
                ...
                String str = "exec [revenuereport] '" + DateTime.ParseExact(txtstartdate.Text, "dd/MM/yyyy", null).ToString("MM/dd/yyyy") + "', '" + DateTime.ParseExact(txtEndDate.Text, "dd/MM/yyyy", null).ToString("MM/dd/yyyy") + "'";
