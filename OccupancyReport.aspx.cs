...
public partial class OccupancyReport : System.Web.UI.Page
{
    ...
    protected void btndownload_Click(object sender, EventArgs e)
    {
        try
        {
            string Path = "Occupancy Report.xls";
    ...
    protected void btnGenerate_Click(object sender, EventArgs e)
    {
        try
        {
            using (SqlConnection cnn = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["constr"].ConnectionString))
            {
                ...
                String str = "exec [occupancyreport] '" + DateTime.ParseExact(txtstartdate.Text, "dd/MM/yyyy", null).ToString("MM/dd/yyyy") + "', '" + DateTime.ParseExact(txtEndDate.Text, "dd/MM/yyyy", null).ToString("MM/dd/yyyy") + "'";
