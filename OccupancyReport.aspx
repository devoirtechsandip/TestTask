<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="OccupancyReport.aspx.cs" Async="true" Inherits="OccupancyReport" %>
...
<cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy" TargetControlID="txtstartdate"></cc1:CalendarExtender>
    ...
    <LayoutTemplate>
        <table id="tbloccreport" class="table no-margin">
            <thead>
                  <tr>
                      ...
                      <th style="text-align:center">Slots Avaliable</th>
                      <th style="text-align:center">Slots Occupied</th>
