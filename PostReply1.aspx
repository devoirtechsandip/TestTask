<%@ Page Title="" Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="PostReply1.aspx.cs" Inherits="PostReply1" %>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div id="reply_ticket_form_container" class="col-md-12 rich_form_container">
                                    ...
                                    <asp:TextBox ID="txtReply1" TextMode="MultiLine" Rows="40" runat="server" class="form-control" name="editor" Height="127px"></asp:TextBox>
            						 
						                    </div>
                    <div class="col-md-12 form-group">
                        <asp:TextBox ID="txtBCC1" runat="server" class="form-control" type="text" name="bcc" value="" placeholder="BCC (Comma separated list)" />
                    </div>
                                        <div class="col-md-3 col-md-offset-6 form-group">
                        <asp:Button runat="server" Onclick="btnSubmitReply_Click1" class="form-control btn btn-success" id="btnSubmitReply" Text="Submit Reply" ></asp:Button>
                    </div>
